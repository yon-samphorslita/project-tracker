            ...
            <div>
              ...
              <div class="flex justify-between border rounded-t-2xl border-b-2 pb-2 p-4 bg-white text-lg font-semibold">
                  <div 
                    ...
                    :class="currentTab === 'all' ? 'border-b-2 border-black font-semibold' : 'text-gray-500'"
                  ...
                  <div 
                    class="w-1/3 cursor-pointer pb-2" 
                    :class="currentTab === 'read' ? 'border-b-2 border-black font-semibold' : 'text-gray-500'"
                  ...
                  <div 
                    class="w-1/3 cursor-pointer pb-2" 
                    :class="currentTab === 'unread' ? 'border-b-2 border-black font-semibold' : 'text-gray-500'"
