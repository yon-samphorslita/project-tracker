...
<script setup>
  ...
  const projectFields = [
    ...
    { type: "textarea", label: "Description", placeholder: "Enter description", model: "description" },
  ...
  const Completed = [
    ...
    },
    {
      ...
      description: "Update the notification center to include: read/unread status, grouping by project, and customizable alert sounds. Ensure mobile/desktop consistency.",
      taskpriority: "Medium",
      user: profileimg,
    },
    {
