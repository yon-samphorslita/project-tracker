  ...
  >
    <div style="display: flex; justify-content: center; align-items: center">
      <img
        src="@/assets/logo.png"
        alt="Logo"
        style="width: 70%; height: auto; overflow-x: hidden; margin-top: 20px; margin-bottom: 10px"
      />
    </div>
    ...
    <div style="margin: 30px">
      <div style="font-size: small; color: gray; margin-left: 20px">Main</div>
    ...
    <div style="margin: 30px">
      <div style="font-size: small; color: gray; margin-left: 20px">Setting & Support</div>
