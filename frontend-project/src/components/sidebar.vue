<template>
    <div class="h-screen w-[250px] top-0 left-0 bg-[#C6E7FF] fixed overflow-hidden flex flex-col">
        <div class="flex justify-center items-center  ">
            <img src="@/assets/logo.png" alt="Logo" style="width: 70%; height: auto; overflow-x: hidden; margin-top: 20px; margin-bottom: 10px;">
        </div>
        
        <hr style="margin-left: 10%; margin-right: 10%;">
        
        <div class="m-8">
            <div class="text-gray-500 text-sm mb-1 ml-5">
                Main
            </div>
            ...
            <!-- Example of hardcoded items, can be removed if not needed -->
            <!-- <div style="display: flex; align-items: center; gap:10px; padding: 5px; border-radius: 5px; margin-left: 25px;">
    ...
    <hr style="margin-left: 10%; margin-right: 10%" />
        ...
        <div class="m-8">
            <div class="text-sm text-gray-500 mb-1 ml-5">
                Setting & Support
            </div>

            <button class="flex align-center gap-3 p-2 w-full rounded-md ml-6 hover:bg-blue-300 cursor-pointer;">
...
defineProps({
  items: {
    type: Array,
    required: true, // Ensure the prop is required
  },
})
</script>
