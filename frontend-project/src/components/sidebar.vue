<template>
    <div style="height: 100vh; width: 250px; top: 0; left: 0; background: #C6E7FF; position: fixed; overflow: hidden;">
        ...
        <div style="margin: 30px">
            <div style="font-size: small; color: gray; margin-left: 20px;">
                Main
            </div>
            ...
            <div
                v-for="item in items"
                :key="item.name"
                style="display: flex; align-items: center; gap:10px; padding: 5px; border-radius: 5px; margin-left: 25px;"
            >
