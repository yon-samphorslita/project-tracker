<template>
  <div class="w-[400px] rounded-lg shadow-lg border border-black bg-white">
    <!-- Header -->
    ...
    <div class="flex mb-3 border-b-2 border-grey-600 pt-4 pb-0 mx-4 space-x-3">
      <div 
        ...
        :class="activeTab === 'all' ? 'border-b-2 border-black font-semibold' : 'text-gray-500'"
      ...
      <div 
        class="cursor-pointer pb-2" 
        :class="activeTab === 'unread' ? 'border-b-2 border-black font-semibold' : 'text-gray-500'"
    ...
    <div class="overflow-scroll w-full max-h-[320px] flex flex-col">
      <div v-if="!notifications.length" class="p-4 text-gray-500 text-center">
      ...
      <div
        ...
        :class="[
          ...
          !n.read_status ? 'bg-blue-50' : 'bg-white'
        ]"
      ...
      >
        <div class="flex justify-between items-center cursor-pointer" @click="markAsRead(n.id)">
          <div class="flex items-center gap-2">
            <div
              v-if="!n.read_status" 
              class="w-2 h-2 bg-blue-500 rounded-full mb-1"
            ></div>
        ...
        <div class="flex justify-between items-start pl-5">
          <div class="text-sm text-gray-500 line-clamp-2 p-1 pl-5">
            {{ n.message }}
          </div>
