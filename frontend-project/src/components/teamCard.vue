<template>
    <!-- <div class="flex flex-col gap-4 "> -->
      <div
        ...
        class="flex flex-col justify-between border w-[400px] h-60 rounded-lg shadow-sm bg-white 
              transition transform hover:scale-[1.02] hover:shadow-md hover:bg-grey-50"
      ...
      >
        ...
        <div class="px-4">
          ...
          <p class="text-gray-600 mb-4 pl-4 line-clamp-3">{{ team.description || 'No description provided.' }}</p>
        </div>
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" 
                stroke-width="2" d="M4 7h16m-10 4v6m4-6v6M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2l1-12M9 
